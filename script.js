...
function preload() {
    this.load.image('paddle', 'assets/lib/img/orange-paddle.png');
    this.load.image('brick', 'assets/lib/img/brick.png');
    this.load.image('destroyed', 'assets/lib/img/destroyed.png');
    this.load.image('ball', 'assets/lib/img/yellow-ball.png');
}
...
function create() {
    ...
    wonTheGameText = this.add.text(this.cameras.main.centerX, this.cameras.main.centerY, 'Happy Valentines!', textStyle)
        .setOrigin(0.5)
        .setPadding(20)
        .setStyle({ backgroundColor: '#111', fill: '#FF5757' })
        .setVisible(false);
    ...
    startButton = this.add.text(this.cameras.main.centerX, this.cameras.main.centerY, 'START GAME', textStyle)
        ...
        .on('pointerover', () => startButton.setStyle({ fill: '#BB1A34' }))
